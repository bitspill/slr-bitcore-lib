...
var LEGACY_VERSION_2 = 2; // V3 - Includes nTime
var LEGACY_VERSION_3 = 3; // V4 - Includes nTime in tx hash
...
Transaction.MAX_MONEY = 1000000000000 * 1e8;
...
Transaction.prototype.toBufferWriter = function(writer) {
  ...
  if (this.version > LEGACY_VERSION_3) {
  ...
  if (this.version > LEGACY_VERSION_1) {
    writer.writeVarintNum(this.txComment.length);
    writer.write(new buffer.Buffer(this.txComment)); // ToDo: Solarcoin, 'hex'?
  }
  return writer;
};
...
Transaction.prototype.fromBufferReader = function(reader) {
  ...
  if (this.version > LEGACY_VERSION_1) {
    var commentLen = reader.readVarintNum();
    this.txComment = reader.read(commentLen);
  }
  return this;
};
...
Transaction.prototype.fromObject = function fromObject(arg) {
  ...
  this.txComment = transaction.txComment;
